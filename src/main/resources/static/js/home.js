                    ...
                    <div class="book-card bg-white rounded shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="/product/${product.productId}" class="btn btn-outline-primary">Chi tiết</a>
                            </div>
                        </div>
                    </div>
                </div>`;
                ...
                <div class="book-card bg-white rounded shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between" style="height: 180px;">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            ${priceHtml}
                            <a href="/product/${product.productId}" class="btn btn-outline-primary btn-sm">Xem chi tiết</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="book-card bg-white rounded shadow-sm h-100">
                                ...
                                <div class="card-body p-2 d-flex flex-column justify-content-between" style="height: 200px;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-2">
                                        ${priceHtml}
                                        <a href="/product/${p.productId}" class="btn btn-outline-primary btn-sm">Xem chi tiết</a>
                                    </div>
                                </div>
                            </div>
                        </div>
